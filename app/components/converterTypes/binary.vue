<template>
  <Page class="page">
    <ActionBar title="Единицы хранения цифровой информации" class="action-bar">
      <NavigationButton
        text="Назад"
...
export default {
  ...
  data() {
    return {
      ...
      displayListOfItems: ["бит", "Б", "Кб", "Мб", "Гб", "Тб", "Пб"],
      selectedOut: 0,
      selectedTo: 0,
      total: "",
    };
    ...
    doConvertig() {
      if (this.selectedOut == 0) {
        ...
        if (this.selectedTo == 2) {
          this.total = `${this.displayField} ${
            this.displayListOfItems[this.selectedOut]
          } = ${Number(this.displayField) / 8 / 1024} ${
            this.displayListOfItems[this.selectedTo]
          }`;
        }
        if (this.selectedTo == 3) {
          this.total = `${this.displayField} ${
            this.displayListOfItems[this.selectedOut]
          } = ${Number(this.displayField) / 8 / 1024 / 1024} ${
            this.displayListOfItems[this.selectedTo]
          }`;
        }
        if (this.selectedTo == 4) {
          this.total = `${this.displayField} ${
            this.displayListOfItems[this.selectedOut]
          } = ${Number(this.displayField) / 8 / 1024 / 1024 / 1024} ${
            this.displayListOfItems[this.selectedTo]
          }`;
        }
        if (this.selectedTo == 5) {
          this.total = `${this.displayField} ${
            this.displayListOfItems[this.selectedOut]
          } = ${Number(this.displayField) / 8 / 1024 / 1024 / 1024 / 1024} ${
            this.displayListOfItems[this.selectedTo]
          }`;
        }
        if (this.selectedTo == 6) {
          this.total = `${this.displayField} ${
            this.displayListOfItems[this.selectedOut]
          } = ${
            Number(this.displayField) / 8 / 1024 / 1024 / 1024 / 1024 / 1024
          } ${this.displayListOfItems[this.selectedTo]}`;
        }
      }
      if (this.selectedOut == 1) {
        ...
        if (this.selectedTo == 3) {
          this.total = `${this.displayField} ${
            this.displayListOfItems[this.selectedOut]
          } = ${Number(this.displayField) / 1024 / 1024} ${
            this.displayListOfItems[this.selectedTo]
          }`;
        }
        if (this.selectedTo == 4) {
          this.total = `${this.displayField} ${
            this.displayListOfItems[this.selectedOut]
          } = ${Number(this.displayField) / 1024 / 1024 / 1024} ${
            this.displayListOfItems[this.selectedTo]
          }`;
        }
        if (this.selectedTo == 5) {
          this.total = `${this.displayField} ${
            this.displayListOfItems[this.selectedOut]
          } = ${Number(this.displayField) / 1024 / 1024 / 1024 / 1024} ${
            this.displayListOfItems[this.selectedTo]
          }`;
        }
        if (this.selectedTo == 6) {
          this.total = `${this.displayField} ${
            this.displayListOfItems[this.selectedOut]
          } = ${Number(this.displayField) / 1024 / 1024 / 1024 / 1024 / 1024} ${
            this.displayListOfItems[this.selectedTo]
          }`;
        }
      }
